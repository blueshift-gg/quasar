...
#[diagnostic::on_unimplemented(
    ...
    note = "discriminators are generated by the `#[account]` and `#[instruction]` \
            attribute macros"
)]
...
#[diagnostic::on_unimplemented(
    ...
    note = "`Space` is generated by `#[account]`; only fixed-layout program data \
            accounts have a compile-time size"
)]
pub trait Space {
    const SPACE: usize;
}
