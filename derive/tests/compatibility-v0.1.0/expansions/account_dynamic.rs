...
const _: () = assert!(
    core::mem::size_of:: < DynamicAccount > () == core::mem::size_of:: <
    ::quasar_lang::__internal::AccountView > (),
    "Pod-dynamic struct must be #[repr(transparent)] over AccountView"
);
impl ::quasar_lang::traits::Discriminator for DynamicAccount {
    const DISCRIMINATOR: &'static [u8] = &[5];
}
impl ::quasar_lang::traits::Owner for DynamicAccount {
...
pub struct DynamicAccountCompactMut<'a> {
    __view: &'a mut ::quasar_lang::__internal::AccountView,
    __payer: &'a ::quasar_lang::__internal::AccountView,
...
pub struct DynamicAccountCompactWriter<'a> {
    ...
    __name: Option<&'a str>,
    __tags: Option<
        &'a [<Address as ::quasar_lang::instruction_arg::InstructionArg>::Zc],
    >,
}
...
::quasar_lang::__private_inventory::submit! {
    ...
    ::quasar_lang::idl_build::vec![5u8], docs : ::quasar_lang::idl_build::Vec::new(),
    space : Some(::quasar_lang::idl_build::__reexport::IdlSpace { discriminator :
    Some(1usize), min : < DynamicAccount as ::quasar_lang::traits::Space > ::SPACE as
    u64, max : None, formula : None, }), },
    ...
    Some(2), encoding : None, item : None, }), docs :
    ::quasar_lang::idl_build::Vec::new(), }], variants :
    ::quasar_lang::idl_build::Vec::new(), repr : None, alias : None, fallback : None,
    codec : None, layout : Some(::quasar_lang::idl_build::__reexport::IdlLayout::Compact
    { inline_fields : ::quasar_lang::idl_build::vec![], tail_fields :
