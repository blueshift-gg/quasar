...
macro_rules! __optional_accounts_instruction {
    (
        ...
        config : ::quasar_lang::prelude::Address, $(pub $arg_name : $arg_ty,)* } #[doc =
        ...
        authority : ::quasar_lang::prelude::Address, pub config :
        ::quasar_lang::prelude::Address, $(pub $arg_name : $arg_ty,)* } impl From <
        $struct_name > for $raw_name { #[allow(unused_variables)] fn from(ix :
        $struct_name) -> $raw_name { $raw_name { authority : ix.authority, config : ix
        .config, $($arg_name : ix. $arg_name,)* } } } impl From < $struct_name > for
    ...
    (
        ...
        : $struct_name) -> $raw_name { $raw_name { authority : ix.authority, config : ix
        .config, $($arg_name : ix. $arg_name,)* remaining_accounts : ix
