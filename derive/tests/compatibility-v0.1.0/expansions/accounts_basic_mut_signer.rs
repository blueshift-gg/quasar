...
macro_rules! __basic_accounts_instruction {
    (
        ...
        : ::quasar_lang::prelude::Address, $(pub $arg_name : $arg_ty,)* } #[doc =
        ...
        pub system_program : ::quasar_lang::prelude::Address, pub rent :
        ::quasar_lang::prelude::Address, $(pub $arg_name : $arg_ty,)* } impl From <
        $struct_name > for $raw_name { #[allow(unused_variables)] fn from(ix :
        $struct_name) -> $raw_name { $raw_name { payer : ix.payer, config : ix.config,
        system_program : super::BasicAccounts::__QUASAR_FIXED_ADDRESS_system_program,
        rent : super::BasicAccounts::__QUASAR_FIXED_ADDRESS_rent, $($arg_name : ix.
        ...
        as ::quasar_lang::client::SerializeArg > ::serialize_arg(& ix. $arg_name));)*
    ...
    (
        ...
        payer : ::quasar_lang::prelude::Address, pub config :
        ...
        ::quasar_lang::client::AccountMeta >, } impl From < $struct_name > for $raw_name
        { #[allow(unused_variables)] fn from(ix : $struct_name) -> $raw_name { $raw_name
        { payer : ix.payer, config : ix.config, system_program :
        super::BasicAccounts::__QUASAR_FIXED_ADDRESS_system_program, rent :
        super::BasicAccounts::__QUASAR_FIXED_ADDRESS_rent, $($arg_name : ix. $arg_name,)*
        remaining_accounts : ix.remaining_accounts, } } } impl From < $struct_name > for
        ::quasar_lang::client::Instruction { #[inline] fn from(ix : $struct_name) ->
        ::quasar_lang::client::Instruction { < $raw_name as ::core::convert::Into <
        ::quasar_lang::client::Instruction >> ::into(< $struct_name as
        ::core::convert::Into < $raw_name >> ::into(ix),) } } impl From < $raw_name > for
