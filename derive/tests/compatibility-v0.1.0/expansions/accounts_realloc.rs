...
macro_rules! __realloc_accounts_instruction {
    (
        ...
        : ::quasar_lang::prelude::Address, pub data : ::quasar_lang::prelude::Address,
        pub system_program : ::quasar_lang::prelude::Address, $(pub $arg_name :
        $arg_ty,)* } impl From < $struct_name > for $raw_name {
        #[allow(unused_variables)] fn from(ix : $struct_name) -> $raw_name { $raw_name {
        payer : ix.payer, data : ix.data, system_program :
        super::ReallocAccounts::__QUASAR_FIXED_ADDRESS_system_program, $($arg_name : ix.
    ...
    (
        ...
        payer : ::quasar_lang::prelude::Address, pub data :
        ::quasar_lang::prelude::Address, pub system_program :
        ::quasar_lang::prelude::Address, $(pub $arg_name : $arg_ty,)* pub
        remaining_accounts : ::alloc::vec::Vec < ::quasar_lang::client::AccountMeta >, }
        impl From < $struct_name > for $raw_name { #[allow(unused_variables)] fn from(ix
        : $struct_name) -> $raw_name { $raw_name { payer : ix.payer, data : ix.data,
        system_program : super::ReallocAccounts::__QUASAR_FIXED_ADDRESS_system_program,
        $($arg_name : ix. $arg_name,)* remaining_accounts : ix.remaining_accounts, } } }
        impl From < $struct_name > for ::quasar_lang::client::Instruction { #[inline] fn
        from(ix : $struct_name) -> ::quasar_lang::client::Instruction { < $raw_name as
