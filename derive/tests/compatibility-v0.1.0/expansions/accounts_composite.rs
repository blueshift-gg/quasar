...
macro_rules! __uses_account_array_instruction {
    (
        ...
        : ::quasar_lang::prelude::Address, pub pairs : ::alloc::vec::Vec <
        ::quasar_lang::client::AccountMeta >, $(pub $arg_name : $arg_ty,)* } impl From <
        $struct_name > for $raw_name { #[allow(unused_variables)] fn from(ix :
        $struct_name) -> $raw_name { $raw_name { payer : ix.payer, pairs : ix.pairs,
        ...
        $raw_name) -> ::quasar_lang::client::Instruction { let accounts = { let mut
        __accounts : ::alloc::vec::Vec < ::quasar_lang::client::AccountMeta > =
    ...
    (
        ...
        r" address the client would otherwise derive."] pub struct $raw_name { pub payer
        : ::quasar_lang::prelude::Address, pub pairs : ::alloc::vec::Vec <
        ::quasar_lang::client::AccountMeta >, $(pub $arg_name : $arg_ty,)* pub
