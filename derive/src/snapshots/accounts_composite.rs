...
impl<'input> ParseAccounts<'input> for UsesAccountArray {
    type Bumps = UsesAccountArrayBumps;
        ...
        let (__chunk, __rest) = unsafe {
            __accounts_rest
                .split_at_mut_unchecked(
                    <AccountsArray<SignerPair, 2> as AccountCount>::COUNT,
                )
        };
        __accounts_rest = __rest;
...
impl UsesAccountArray {
    ...
    pub unsafe fn parse_direct_with_instruction_data_unchecked(
        ...
        __ix_data: &[u8],
        __program_id: &quasar_lang::prelude::Address,
    ) -> Result<(Self, UsesAccountArrayBumps), ProgramError> {
...
unsafe impl quasar_lang::traits::ParseAccountsRaw for UsesAccountArray {
    ...
    unsafe fn parse_accounts_raw(
        ...
        let mut __j = 0usize;
        while __j < 1usize + <AccountsArray<SignerPair, 2> as AccountCount>::COUNT {
            core::ptr::write(
                base.add(offset + __j),
...
macro_rules! __uses_account_array_instruction {
    ($struct_name:ident, [$($disc:expr),*], { $($arg_name:ident : $arg_ty:ty),* }) => {
        ...
        ::alloc::vec![quasar_lang::client::AccountMeta::new_readonly(ix.payer, true),
        quasar_lang::client::AccountMeta::new_readonly(ix.pairs, false),]; let data = {
    ...
    (
        ...
        ::alloc::vec![quasar_lang::client::AccountMeta::new_readonly(ix.payer, true),
        quasar_lang::client::AccountMeta::new_readonly(ix.pairs, false),]; accounts
...
quasar_lang::__private_inventory::submit! {
    ...
    quasar_lang::idl_build::s("pairs"), client_type : None, optional : false, writable :
