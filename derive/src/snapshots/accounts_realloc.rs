...
impl<'input> ParseAccounts<'input> for ReallocAccounts {
    type Bumps = ReallocAccountsBumps;
...
impl ReallocAccounts {
    ...
    pub unsafe fn parse_accounts(
        ...
        }
        {
            ...
            quasar_lang::debug_log!(
                concat!("Account '", stringify!(data), "' (index ", "0usize + 1usize",
                "): validation passed")
            );
        }
        {
    ...
    pub unsafe fn parse_direct_with_instruction_data_unchecked(
        ...
        __ix_data: &[u8],
        __program_id: &quasar_lang::prelude::Address,
    ) -> Result<(Self, ReallocAccountsBumps), ProgramError> {
...
quasar_lang::__private_inventory::submit! {
    ...
    quasar_lang::idl_build::s("data"), client_type : None, optional : false, writable :
