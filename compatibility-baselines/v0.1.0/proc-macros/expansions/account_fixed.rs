...
impl ::quasar_lang::traits::Discriminator for MixedAccount {
    const DISCRIMINATOR: &'static [u8] = &[6];
}
impl ::quasar_lang::traits::Owner for MixedAccount {
    const OWNER: ::quasar_lang::prelude::Address = crate::ID;
}
impl ::quasar_lang::traits::Space for MixedAccount {
...
::quasar_lang::__private_inventory::submit! {
    ...
    ::quasar_lang::idl_build::vec![6u8], docs : ::quasar_lang::idl_build::Vec::new(),
    space : Some(::quasar_lang::idl_build::__reexport::IdlSpace { discriminator :
    Some(1usize), min : < MixedAccount as ::quasar_lang::traits::Space > ::SPACE as u64,
    max : None, formula : None, }), }, ::quasar_lang::idl_build::__reexport::IdlTypeDef {
    name : ::quasar_lang::idl_build::s("MixedAccount"), kind :
    ...
    codec : None, layout : Some(::quasar_lang::idl_build::__reexport::IdlLayout::Fixed {
    fields : ::quasar_lang::idl_build::vec![::quasar_lang::idl_build::s("authority"),
