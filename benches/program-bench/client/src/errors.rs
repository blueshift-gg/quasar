...
pub enum QuasarBenchError {
    ...
    RequireEqFailed = 6000,
    ReturnDataFromWrongProgram = 3018,
}

impl QuasarBenchError {
    pub fn from_code(code: u32) -> Option<Self> {
        match code {
            ...
            6000 => Some(Self::RequireEqFailed),
    ...
    pub fn message(&self) -> &'static str {
        match self {
            ...
            Self::RequireEqFailed => "RequireEqFailed",
            Self::ReturnDataFromWrongProgram => "Return data was set by a different program than the one invoked.",
        }
    }
}

impl From<QuasarBenchError> for u32 {
    fn from(error: QuasarBenchError) -> Self {
        error as u32
    }
}
